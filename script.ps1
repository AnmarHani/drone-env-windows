...
Start-Process powershell ".\cygwin-script.ps1", "$($drive.ToUpper())", "/cygdrive/$($drive.ToLower())/$secondNF_path/ardupilot", "./Tools/autotest/sim_vehicle.py -v ArduCopter --map --console"
if($have_vscode -eq 1){
  cd ..
  cd Scripts
  code .
